 ...
 *      *** Do not modify ! ***
 *
 * Project: 'send_data_dma_to_gpio_pheripheral' 
 * Target:  'Target 1' 
 */
...
/*  Keil::Device:STM32Cube HAL:EXTI:1.7.6 */
...
/*  Keil::Device:STM32Cube LL:Common:1.2.7 */
#define RTE_DEVICE_LL_COMMON
/*  Keil::Device:STM32Cube LL:GPIO:1.2.7 */
#define RTE_DEVICE_LL_GPIO
/*  Keil::Device:STM32Cube LL:PWR:1.2.7 */
#define RTE_DEVICE_LL_PWR
/*  Keil::Device:STM32Cube LL:RCC:1.2.7 */
#define RTE_DEVICE_LL_RCC
/*  Keil::Device:STM32Cube LL:USART:1.2.7 */
#define RTE_DEVICE_LL_USART
/*  Keil::Device:STM32Cube LL:UTILS:1.2.7 */
